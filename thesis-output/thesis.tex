...
\newcommand{\thesisdate}{October 31, 2021}
...
\midrule
\textbf{mean > 2010} & \textbf{33.5} & \textbf{3.8} & \textbf{657} & \textbf{3.3} & \textbf{TRUE}\\
\midrule
\textbf{mean 2021} & \textbf{40.5} & \textbf{4.6} & \textbf{543} & \textbf{4.6} & \textbf{TRUE}\\
\midrule
\textbf{mean 2030} & \textbf{63.5} & \textbf{7.2} & \textbf{347} & \textbf{1.75} & \textbf{TRUE}\\
\midrule
\bottomrule
\end{tabular}
\end{table}
Linow {[}\protect\hyperlink{ref-SvenLinow.2020}{48}{]}, if compared with the occurrence of this wind speed shown in figure \ref{fig:wind} at 140 m above ground, it seems rather unlikely.
