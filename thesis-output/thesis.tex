...
\newcommand{\thesisdate}{October 09, 2021}
...
\end{figure}
In addition to its load-bearing function, the tower also contains the power lines that conduct electricity to the grid connection of the distribution network {[}\protect\hyperlink{ref-NetzKonstrukteur.16.11.2020}{24}{]}. In the first half of 2021, in Germany 240 new wind turbines with a installed rated capacity of 971 MW. Compared to the first six months of the previous year corresponds to an increase of 62\%. In the same period 135 WT's with an installed capacity of 140 MW were shut down. The net expansion in the first half of 2021 is consequently 831 MW. The cumulative installed capacity increased by 1.5\% to 55,772 MW as of June 30, 2021. A total of 29,715 onshore WT's are installed in Germany that provide this capacity. To achieve the expansion target for 2022 is thus yet another net addition of around 1.2 GW required. The target, which originates from the EEG 2021, for 2030 is 71,000 MW installed but is not yet adapted by the expected increase in electricity demand in 2030.
\begin{figure}
...
\item
  ...
  {[}\protect\hyperlink{ref-MinisteriumfurUmweltEnergieErnahrungundForsten.2020}{36}{]}
\end{itemize}
...
\end{equation}
(Mac Kay {[}\protect\hyperlink{ref-DavidJCMacKay.2009}{37}{]} and BWE {[}\protect\hyperlink{ref-BWE.2021}{38}{]})
...
\end{figure}
The maximum theoretical efficiency obtained for wind turbines is 59\% according to the Betz Limit {[}\protect\hyperlink{ref-A.Betz.1920}{39}{]}; however, in practice it is often around 40\% up to a maximum of 50\% {[}\protect\hyperlink{ref-WindwartsEnergieausdemNorden.2021}{40}{]}. If the average rotor diameter installed in RLP in 2020 is 130 m (Figure \ref{fig:rotor}) with an efficiency of 50\%, then the average power of one WT is\footnote{\(P_{WT}=Power\; of\; a\; WT\; with\; 50\; \%\; efficiency,\;\\ P_{WT130}=Power\; of\; the\; same\; WT\; with\; rotor\; diameter\; of\; 130\; m\)}:
\begin{equation}
\begin{split}
