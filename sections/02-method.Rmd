...
Rhineland-Palatinate is one of the most densely forested countries in Germany, as the forests here cover around 42 percent of the country's area @HansenandLamour.2021.
...
df <- matrix(data = c(row1, row2, row3, row4, row5, row6, row7), nrow = 7, byrow = T)
...
row_spec(1:7, hline_after = T, bold = T) %>%
...
```{r flh, echo=FALSE, fig.cap="Development and forecast of the mean full-load-hours. Figure taken from Deutsche WindGuard 2020", out.width = "100%"}
...
```{r capacity, echo=FALSE, fig.cap="Development and forecast of the mean rated capacity. Figure taken from Deutsche WindGuard 2020", out.width = "100%", fig.pos="H"}
...
```{r rotor, echo=FALSE, fig.cap="Development and forecast of the mean rotor diameter. Figure taken from Deutsche WindGuard 2020", out.width = "100%"}
knitr::include_graphics("figures/DWG/DWG_Rotordurchmesser.png")
```

```{r nabe, echo=FALSE, fig.cap="Development and forecast of mean hub hight. Figure taken from Deutsche WindGuard 2020", out.width = "100%", fig.pos="H"}
...
```{r spec, echo=FALSE, fig.cap="Development and forecast of the mean specific rated capacity. Figure taken from Deutsche WindGuard 2020", out.width = "100%", fig.pos="H"}
