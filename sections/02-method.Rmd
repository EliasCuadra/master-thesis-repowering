...
```{r repowering, echo=FALSE, fig.cap="(ref:dwg2)", out.width = "100%", fig.pos="H"}
...
```{r flh, echo=FALSE, fig.cap="Development and forecast of the mean full-load-hours (in h/a) for WTs installed in Germany. Figure taken from Deutsche WindGuard 2020.", out.width = "100%", fig.pos="H"}
...
```{r rotor, echo=FALSE, fig.cap="Development and forecast of the mean rotor diameter (in m) for WTs installed in Germany. Figure taken from Deutsche WindGuard 2020", out.width = "100%"}
knitr::include_graphics("figures/DWG/DWG_Rotordurchmesser.png")
```

```{r nabe, echo=FALSE, fig.cap="Development and forecast of mean hub hight (in m) for WTs installed in Germany. Figure taken from Deutsche WindGuard 2020.", out.width = "100%", fig.pos="H"}
...
```{r spec, echo=FALSE, fig.cap="Development and forecast of the mean specific rated capacity (in W/m²) for WTs installed in Germany. Figure taken from Deutsche WindGuard 2020.", out.width = "100%", fig.pos="H"}
