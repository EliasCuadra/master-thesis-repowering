...
```{r diagnostics, echo=FALSE, fig.cap="Example diagnostic plot of linear model of the electricity yield of all WT'S in RLP over the commissioning date in 2019 from the transmition system operator Amprion created with the plot() function in base R", out.width = "100%", fig.pos="H"}
