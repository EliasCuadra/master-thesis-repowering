...
knitr::kable(
  df,
  booktabs = TRUE,
  caption = "Repowering potential based on the 100 percent replacement of wind turbines commissioned either 
...
means     <- c(
  "mean > 2010", 27.4, 3.1, 802.3 , 4.0, 6.70
)
stddev    <- c(
  "mean 2021", 33.5, 3.8, 656.7, 3.3, 7.17
)
x    <- c(
  "mean 2030", 40.5, 4.6, 543.2, 2.7, 7.63
)
