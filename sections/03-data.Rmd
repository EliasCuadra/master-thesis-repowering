...
```{r yearswts, echo=FALSE, fig.cap="Number of total WTs in RLP from 2012 to 2019 according to transmission system operator Amprion", out.width = "100%"}
